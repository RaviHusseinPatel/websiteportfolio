  ...
  const projects = [
    {
      ...
      description: "This project is a group project that utilizes the React library and a Java SpringBoot API to create a web application that allows users to view updates from around the world. The application integrates with the Google Maps API, Geolocation API, and Google Search API to provide a rich and interactive user experience. It also utilizes Firebase Storage to save information about users and their uploaded pictures. ",
