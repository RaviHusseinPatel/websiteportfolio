...
function Contact({}: Props) {
  ...
  return (
    ...
    >
      ...
      <h3 className="mx-auto  absolute top-16 uppercase tracking-[20px] text-gray-500 text-lg md:text-2xl ">
        Contact
      </h3>
      ...
      <div className="flex flex-col space-y-10 mt-14">
        ...
        <div className="space-y-10 pt-10 lg:pt-20">
          <div className="flex items-center space-x-5 justify-center  ">
            ...
            <a
              className="text-xl border-b-2 border-dotted border-[#8A9A5B]"
        ...
        <form
          ref={form}
          onSubmit={sendEmail}
          className="mx-auto flex flex-col space-y-2 w-full pt-5 "
        >
